...
<html <?php language_attributes() ?>>
    <head>
        ...
        <meta name="theme-color" content="#A98370">

        <link rel="apple-touch-icon" sizes="180x180" href="<?php bloginfo('stylesheet_directory') ?>/assets/img/favicon/apple-touch-icon.png">
